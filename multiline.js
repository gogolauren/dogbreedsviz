...
// Get the max of every yFunct
    ...
    chartObj.yScale = d3.scale.linear()
           // .range([500,550,600,650,700,750,800,850,900,1000,2000,3000])
        .range([chartObj.height, 0])
        .domain([500, d3.max(chartObj.yFuncts.map(chartObj.max))]);
...
// Render the chart
    chartObj.render = function () {
      ...
      // focus
        ...
        // Year label
        focus.append("text").attr("class", "focus year").attr("x", 800).attr("y", 7);
